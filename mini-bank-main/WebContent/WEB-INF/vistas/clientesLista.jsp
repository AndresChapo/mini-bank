		...
		<ul class="navbar-nav">
			<div class="row">
				...
				<div class="col-md-2">
                  ...
                  <div class="col-md-2">
					<li class="nav-item active"><a class="nav-link"
						href="ClientesDatosPersonales.html">Nuevo Cliente <span class="sr-only">(current)</span>
					</a></li>
				</div>
					...
					<tbody>
					  ...
					  <c:forEach items="${listaClientes}" var="cliente">
					    <tr>
							...
							<td style="width: 131px;"><a class="btn btn-primary" href="clientesNuevoDatosPersonales">Nueva Cuenta</a></td>
