	...
	<div class="container">
		...
		<div class="row mt-2 d-flex justify-content-center"
			...
			<div class="col-md-6" style="">
				...
				<form action="ClientesDatosPersonales.html" method="get">
					...
					<div class="form-row">					
						...
						<div class="col">
							<input type="text" class="form-control" name="TXTnombreC"
								id="nombre" aria-describedby="emailHelp" placeholder="Nombres"
								required>
						</div>
						<div class="col">
							<input type="text" class="form-control" name="TXTapellidoC"
					...
					<div class="form-row">
						<div class="col">
							<input type="number" class="form-control" name="TXTdnic"
								id="nombre" aria-describedby="emailHelp" placeholder="DNI"
								required>
						</div>
					...
					<div class="form-row">
						<div class="col">
							<input type="date" class="form-control" name="TXTfechaC"
								id="nacimiento" aria-describedby="emailHelp" placeholder="DD"
								required>
						</div>
					...
					<div class="row d-flex justify-content-center"
						...
						<a class="btn btn-primary" href="clientesNuevoDireccion.jsp">Siguiente</a>
					</div>
